      ...
      cards={[
        {
          id: 'r1',
          content: (
            <div className="bg-white p-8 rounded-none shadow-sm max-w-lg mx-auto">
              <div className="text-[#C9A96E] text-sm mb-3">★★★★★</div>
              ...
              <span className="text-xs font-bold text-[#1A1A1A] tracking-wider uppercase">— Marcus</span>
            </div>
          ),
        },
        {
          ...
          content: (
            <div className="bg-white p-8 rounded-none shadow-sm max-w-lg mx-auto">
              ...
              <span className="text-xs font-bold text-[#1A1A1A] tracking-wider uppercase">— Samira</span>
            </div>
          ),
        },
        {
          ...
          content: (
            <div className="bg-white p-8 rounded-none shadow-sm max-w-lg mx-auto">
              ...
              <span className="text-xs font-bold text-[#1A1A1A] tracking-wider uppercase">— David</span>
            </div>
          ),
        },
        {
          ...
          content: (
            <div className="bg-white p-8 rounded-none shadow-sm max-w-lg mx-auto">
              ...
              <span className="text-xs font-bold text-[#1A1A1A] tracking-wider uppercase">— Elena</span>
            </div>
          ),
        },
      ]}
